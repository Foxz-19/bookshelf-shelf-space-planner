...
with sync_playwright() as p:
    ...
    assert page.get_by_role("heading", name="1h 35m to rest").is_visible()
    ...
    assert page.get_by_text("12:10 AM").is_visible()
    assert page.get_by_text("12:20 AM").is_visible()
    page.locator("#now").fill("13:00")
    ...
    page.get_by_role("button", name="Find my perfect nap").click()
    page.wait_for_selector("h2:has-text('A tiny window')")
    assert page.get_by_role("heading", name="A tiny window").is_visible()
